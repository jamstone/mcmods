...
public class BlockBogWaterStationary extends BlockStationary {
    public BlockBogWaterStationary(int id) {
        this(id, Material.water);
    }

    public BlockBogWaterStationary(int par1, Material par2Material) {
