...
public class WorldGenBigTree2 extends WorldGenerator {
    /**
    ...
    public WorldGenBigTree2(boolean par1, int woodType) {
	super(par1);
	wood = (byte) woodType;
    }
	...
	int var1 = (int) (1.382D + Math.pow(this.leafDensity * this.heightLimit
		/ 13.0D, 2.0D));
	...
	while (var6 >= 0) {
		...
		for (double var9 = 0.5D; var7 < var1; ++var7) {
		    double var11 = this.scaleWidth * var8
		    ...
		    int[] var18 = new int[] { var15,
			    var3 + this.leafDistanceLimit, var16 };

		    if (this.checkBlockLine(var17, var18) == -1) {
			int[] var19 = new int[] { this.basePos[0],
				this.basePos[1], this.basePos[2] };
			double var20 = Math.sqrt(Math.pow(
				Math.abs(this.basePos[0] - var17[0]), 2.0D)
				+ Math.pow(
					Math.abs(this.basePos[2] - var17[2]),
					2.0D));
	...
	for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
	    ...
	    while (var13 <= var7) {
		double var15 = Math.pow(Math.abs(var12) + 0.5D, 2.0D)
		...
		if (var15 > (par4 * par4)) {
		    ...
		    int var14 = this.worldObj.getBlockId(var11[0], var11[1],
			    var11[2]);

		    if (var14 != 0 && var14 != Block.leaves.blockID) {
			++var13;
		    } else {
			this.setBlockAndMetadata(this.worldObj, var11[0],
				var11[1], var11[2], par6, wood);
			++var13;
		    }
		}
	    }
	...
	if (var4[var6] != 0) {
		...
		this.setBlockAndMetadata(this.worldObj, var14[0], var14[1],
			var14[2], par3, var17);
	    }
	}
    }
	...
	for (int[] var3 = new int[] { this.basePos[0], this.basePos[1],
		this.basePos[2] }; var1 < var2; ++var1) {
	...
	if (var3[var5] == 0) {
		...
		var13[var7] = MathHelper.floor_double(par1ArrayOfInteger[var7]
			+ var14 * var11);
		int var16 = this.worldObj.getBlockId(var13[0], var13[1],
			var13[2]);
	...
	int[] var1 = new int[] { this.basePos[0], this.basePos[1],
		this.basePos[2] };
	int[] var2 = new int[] { this.basePos[0],
		this.basePos[1] + this.heightLimit - 1, this.basePos[2] };
	int var3 = this.worldObj.getBlockId(this.basePos[0],
