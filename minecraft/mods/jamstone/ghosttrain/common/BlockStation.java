...
public class BlockStation extends Block implements ITileEntityProvider {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        TileEntityStation tileEntity = (TileEntityStation) getTileEntity(world, x, y, z);
        if (tileEntity == null || player.isSneaking()) {
            return false;
        }

        tileEntity.onActivatedByPlayer(world, x, y, z, player);
        //  player.openGui(GhostTrain.instance, 0, world, tileEntity.xCoord, tileEntity.yCoord, tileEntity.zCoord);
