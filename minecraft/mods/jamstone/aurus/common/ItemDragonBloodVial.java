...
public class ItemDragonBloodVial extends Item {
    ...
    public void addInformation(ItemStack is, EntityPlayer player, List list,
        ...
        list.add(percent + "% full. " + EnumChatFormatting.DARK_RED + guilt);
    }

    public void registerIcons(IconRegister iconRegister) {
        icons.add(iconRegister.registerIcon("jamstone_aurus:auruBloodVial1"));
        icons.add(iconRegister.registerIcon("jamstone_aurus:auruBloodVial2"));
        icons.add(iconRegister.registerIcon("jamstone_aurus:auruBloodVial3"));
        icons.add(iconRegister.registerIcon("jamstone_aurus:auruBloodVial4"));
